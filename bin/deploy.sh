...
EOF
  ...
  #PODCAST_ASSETS_S3_BUCKET=${PODCAST_ASSETS_S3_BUCKET}
  #PODCAST_ASSETS_S3_BUCKET_FOLDER=${PODCAST_ASSETS_S3_BUCKET_FOLDER}
  #PODCAST_INPUT_S3_BUCKET=${PODCAST_INPUT_S3_BUCKET}
  #PODCAST_OUTPUT_S3_BUCKET=${PODCAST_OUTPUT_S3_BUCKET}
